...
def main():
    ...
    root_dir = '../../../../data/jlorray1/SDU-GAMODv4/'  # '../../../SDU-GAMODv4/unsupervised_annotations/'
    json_file = root_dir + 'supervised_annotations/aerial/aligned_ids/aerial_train_aligned_ids_w_indicator.json'
    ...
    output_file_label = root_dir + 'supervised_annotations/aerial/aligned_ids/aerial_train_aligned_ids_w_indicator.json'
    ## save to json
